...
interface KidsHeroBannerProps {
  banners?: CategorySlide[];
  autoPlayInterval?: number;
}

export const KidsHeroBanner: React.FC<KidsHeroBannerProps> = ({
  banners = categoryBannersData.kids,
  ...
  return (
    <section
      className="relative w-full h-[50vh] min-h-[420px] max-h-[480px] overflow-hidden select-none"
    ...
    >
      ...
      <div className="relative z-20 h-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop flex flex-col justify-center">
        <div className="max-w-2xl text-white">
          <span className="font-label-caps text-[11px] uppercase tracking-[0.3em] mb-3 block text-white/80">
            Youth Collection
          </span>
          <h1 className="font-display-lg text-[44px] md:text-display-lg uppercase tracking-tighter mb-3 text-white drop-shadow-md">
            Kids' Collection
          </h1>
          <p className="font-body-lg text-white/90 max-w-lg text-sm md:text-base leading-relaxed">
            An elevated collection for the next generation. Timeless silhouettes and quiet luxury.
          </p>
        </div>
      </div>
