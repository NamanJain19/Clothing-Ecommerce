      ...
      <div className="p-4 sm:p-space-xl max-w-[1200px] mx-auto w-full space-y-space-lg">
        ...
        <div className="p-4 bg-amber-50/70 border border-amber-200 rounded-xl text-xs text-amber-900 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span>Transactional customer emails (Order Confirmation, Tracking, Password Reset) are compiled server-side via Resend (<code>backend/src/services/emailService.js</code>).</span>
          </div>
        </div>
