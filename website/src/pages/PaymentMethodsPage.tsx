      ...
      <main className="pt-24 pb-section-gap max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        {isAddCardOpen && (
          <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
            <div className="bg-white max-w-[calc(100vw-24px)] sm:max-w-md w-full p-5 sm:p-8 border border-outline-variant shadow-2xl relative space-y-6 my-auto max-h-[90vh] overflow-y-auto">
