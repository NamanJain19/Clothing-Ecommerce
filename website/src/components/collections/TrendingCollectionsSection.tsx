    ...
    <section className="mb-section-gap">
      <div className="flex justify-between items-end mb-12 border-b border-outline-variant pb-6">
        <div>
          ...
          <h2 className="font-display-lg text-3xl sm:text-4xl">Trending Collections</h2>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter">
        ...
        >
          ...
          <div className="absolute inset-0 bg-black/30 flex flex-col justify-end p-6 sm:p-10 text-white">
            <h3 className="font-headline-md text-2xl sm:text-3xl mb-2">Luxury Essentials</h3>
        ...
        >
          ...
          <div className="absolute inset-0 bg-black/30 flex flex-col justify-end p-6 sm:p-10 text-white">
            <h3 className="font-headline-md text-2xl sm:text-3xl mb-2">Limited Edition</h3>
            <p className="font-body-md text-sm text-white/80 mb-6 max-w-xs">
