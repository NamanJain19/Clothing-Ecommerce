  ...
  return (
    <div className="min-h-screen bg-background text-primary font-body-md antialiased selection:bg-primary-container selection:text-white">
      ...
      <main className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <section className="bg-black text-white p-6 sm:p-12 md:p-20 mb-section-gap relative overflow-hidden">
          <div className="max-w-2xl relative z-10">
            <span className="font-label-caps text-[10px] tracking-[0.5em] uppercase text-white/60 mb-4 sm:mb-6 block">
              The Triptych Philosophy
            </span>
            <h2 className="font-display-lg text-3xl sm:text-4xl md:text-5xl italic mb-4 sm:mb-6 leading-tight">
              Identity in Three Acts
            </h2>
            <p className="font-body-lg text-white/80 mb-8 sm:mb-10 leading-relaxed text-sm sm:text-base">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              <a
                href="/women"
                className="text-center px-8 py-4 bg-white text-black font-button text-[11px] uppercase tracking-widest hover:bg-black hover:text-white border border-white transition-all duration-300"
              >
                Explore Women
              </a>
              <a
                href="/men"
                className="text-center px-8 py-4 border border-white text-white font-button text-[11px] uppercase tracking-widest hover:bg-white hover:text-black transition-all duration-300"
              >
                Explore Men
              </a>
            </div>
