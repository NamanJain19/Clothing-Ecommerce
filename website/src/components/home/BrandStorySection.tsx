  ...
  return (
    <section className="py-section-gap border-t border-outline/10" id="brand-story">
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop grid grid-cols-1 md:grid-cols-12 items-center gap-0 bg-white shadow-xl">
        <div className="col-span-1 md:col-span-6 h-[300px] sm:h-[420px] md:h-[700px] overflow-hidden">
          <img
        ...
        <div className="col-span-1 md:col-span-6 px-6 sm:px-12 md:px-24 py-10 sm:py-16 md:py-20 flex flex-col items-start justify-center">
          <span className="font-label-caps text-[10px] tracking-[0.5em] uppercase text-secondary mb-6 sm:mb-10 block">
            Since MCMXCIV
          </span>
          <h2 className="font-display-lg text-2xl sm:text-3xl md:text-headline-lg mb-6 sm:mb-8 leading-tight">
            The Architecture of Identity
          </h2>
          <p className="font-body-lg text-sm sm:text-base md:text-body-lg text-secondary mb-8 sm:mb-12 leading-relaxed">
          ...
          <Link
            className="w-full sm:w-auto px-8 sm:px-12 py-4 sm:py-5 bg-black text-white font-button text-[12px] uppercase tracking-[0.2em] hover:bg-secondary transition-all duration-300 text-center"
            to="/about-us"
          >
            Our Philosophy
          </Link>
